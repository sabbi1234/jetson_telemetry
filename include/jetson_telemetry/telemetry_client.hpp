#ifndef JETSON_TELEMETRY__TELEMETRY_CLIENT_HPP_
#define JETSON_TELEMETRY__TELEMETRY_CLIENT_HPP_
...
class TelemetryClient : public rclcpp::Node
{
public:
  TelemetryClient();
  ~TelemetryClient();
...
private:
  ...
  // cpu and memory usage retrieval can be added here
...
#endif  // JETSON_TELEMETRY__TELEMETRY_CLIENT_HPP_